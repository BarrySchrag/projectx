...
# python sprint3.py --video ./media/20171014_180142.mp4 --width 640
# Static camera male subject outdoor, ball drop black
# python sprint3.py --video ./media/00001-Dup15rVd2eU.mp4 --width 640
# Static camera male subject outdoor, ball drop multiple types
# python sprint3.py --video ./media/Ball_Bounce_Reference-sKJegbjS4N8.mp4 --width 640
# Static camera poplar subject outdoor, wind
# python sprint3.py --video ./media/The_sky..._The_wind..._A_poplar_tree-f9clDwjYX-Y.mp4 --width 640
